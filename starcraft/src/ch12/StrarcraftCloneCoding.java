...
import ch12.unit.Marine;
import ch12.unit.Medic;
import ch12.unit.Unit;
import ch12.unit.Zealot;
import ch12.unit.Zergling;
...
public class StrarcraftCloneCoding {
	...
	public static void main(String[] args) {
		...
		Medic m1 = new Medic();
		System.out.println("저글링#1이 메딕을 2회 공격\n");
		zerglings[0].attack(m1, 2);		
		m1.reportStatus();
		System.out.println();
